...
#
# (2) The Gradle build system does not require a sign-in, so GRADLE_USER_HOME
#     can be in the working directory.
#
# Attention: this script does not set the default value of GRADLE_USER_HOME.
#
##############################################################################
